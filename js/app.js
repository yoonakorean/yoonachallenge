...
function updateUIProfile(data) {
    ...
    if (profAvatar && data.photoURL) profAvatar.src = data.photoURL;
...
async function renderGlobalLeaderboard() {
    ...
    container.innerHTML = sorted.map((m, idx) => `
        <div style="display:flex; align-items:center; gap:10px; padding:8px 4px; border-bottom:1px solid #f3f4f6; text-align:left;">
            ...
            <img src="${m.photoURL || 'https://placehold.co/40x40'}" style="width:36px; height:36px; border-radius:50%; object-fit:cover;" alt="">
            <div style="flex:1;">
